...
public class AlgorithmConfiguration_StigmergyElite extends AbstractAlgorithmConfiguration {
    ...
    public void prepareConfigParameters() {
        ...
        evapFactor.setExpressions(new Float[]{0.7f, 0.75f, 0.8f, 0.85f, 0.9f, 0.95f});
        //evapFactor.setExpressions(new Float[]{0.1f,0.3f,0.5f,0.7f,0.9f});

        ConfigurationParameter<Integer> maxIterations =
                new ConfigurationParameter<>("maxIterations", 2000);
    ...
    public AbstractAlgorithm create(SCProblem problem) {
        ...
        AbstractTerminationCriterion termCriterion =
                new TerminationCriterionNew(this.getParameter("maxIterations").getCurrentValue().intValue(), 100);
